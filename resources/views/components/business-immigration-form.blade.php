<div id="skilled-worker-form">
    <form class="form-horizontal relative" style="margin-top:15px;">
        ...
        <div :class="errors.fullname ? 'form-group has-error' : 'form-group'">
            <label for="fullname" class="col-sm-4 control-label">Full Name<span class="spanHighlight">*</span> (As per
                your passport)</label>
            <div class="col-sm-8">
                <input name="fullname" class="form-control w-min" v-model="model.fullname">
        ...
        <div :class="errors.email ? 'form-group has-error' : 'form-group'">
            <label for="email" class="col-sm-4 control-label">E-mail<span class="spanHighlight">*</span> (As per your
                passport)</label>
            <div class="col-sm-8">
                <input @auth('web') readonly="true" @endauth name="email" class="form-control w-min"
        ...
        <div :class="errors.phone ? 'form-group has-error' : 'form-group'">
            <label for="phone" class="col-sm-4 control-label">Phone Number (with country and area code)<span
                    class="spanHighlight">*</span></label>
            <div class="col-sm-8">
                <input name="phone" class="form-control w-min" v-model="model.phone">
        ...
        <div :class="errors.country ? 'form-group has-error' : 'form-group'">
            <label for="country" class="col-sm-4 control-label">What is your current country of residence?<span
                    class="spanHighlight">*</span></label>
            <div class="col-sm-8">
                <select class="form-control w-min" id="country" name="country" v-model="model.country">
        ...
        <div :class="errors.nationality ? 'form-group has-error' : 'form-group'">
            <label for="nationality" class="col-sm-4 control-label">What is your nationality?<span
                    class="spanHighlight">*</span></label>
            <div class="col-sm-8">
                <input name="nationality" class="form-control w-min" v-model="model.nationality">
        ...
        <div :class="errors.reference ? 'form-group has-error' : 'form-group'">
            <label for="reference" class="col-sm-4 control-label">Who provided you our reference?*<span
                    class="spanHighlight">*</span></label>
            <div class="col-sm-8">
                <input name="reference" class="form-control w-min" v-model="model.reference">
        ...
        <div :class="errors.currently_in_canada ? 'form-group has-error' : 'form-group'">
            <label for="child-6" class="col-sm-4 control-label">Are you currently in Canada ?<span
                    class="spanHighlight">*</span></label>
            <div class="col-sm-8">
        ...
        <div :class="errors.experience ? 'form-group has-error' : 'form-group'">
            <label for="child-6" class="col-sm-4 control-label">Please select which experience pertains to you<span
                    class="spanHighlight">*</span></label>
            <div class="col-sm-8">
                <label class="radio-inline">
                    <input type="radio" v-model="model.experience" value="business_person">Business Person</label>
                <label class="radio-inline">
                    <input type="radio" v-model="model.experience" value="senior_manager">Senior Manager</label>
                <label class="radio-inline">
        ...
        <div class="form-group">
            <label for="aoi" class="col-sm-4 control-label">What area of business or management experience have you
                acquired in the past 10 years (you can select more than one option)<span
                    class="spanHighlight">*</span></label>
            <div class="col-sm-8">
                <div class="checkbox">
                    <label>
                        <input type="checkbox" value="manufacturing" v-model="model.aoi" />Manufacturing /
                        trading</label>
                </div>
                <div class="checkbox">
                    <label>
                ...
                <div class="checkbox">
                    <label>
                        <input type="checkbox" value="consulting" v-model="model.aoi" />Consulting</label>
                </div>
                <div class="checkbox">
                    <label>
                        <input type="checkbox" value="other" v-model="model.aoi" />Other</label>
                </div>
            </div>
        </div>
        <div class="form-group">
            <label for="describe" class="col-sm-4 control-label">Briefly describe product/commodity you deal in your
                business<span class="spanHighlight">*</span></label>
            <div class="col-sm-8">
        ...
        <div :class="errors.qualification ? 'form-group has-error' : 'form-group'">
            <label for="child-6" class="col-sm-4 control-label">What is your education qualification?<span
                    class="spanHighlight">*</span></label>
            <div class="col-sm-8">
                <label class="radio">
                    <input type="radio" v-model="model.qualification" value="1">Post graduate</label>
                <label class="radio">
                ...
                <label class="radio">
                    ...
                    year diploma / certificate</label>
                <label class="radio">
                    <input type="radio" v-model="model.qualification" value="5">Grade 12 (Secondary school)
                    completed</label>
                <label class="radio">
                    <input type="radio" v-model="model.qualification" value="6">Grade 10 completed</label>
                <label class="radio">
                    <input type="radio" v-model="model.qualification" value="7">Grade 10 not completed</label>
                <label class="radio">
                    <input type="radio" v-model="model.qualification" value="8">Other</label>
        ...
        <div :class="errors.dob ? 'form-group has-error' : 'form-group'">
            <label for="dob" class="col-sm-4 control-label">Date of birth<span class="spanHighlight">*</span></label>
            <div class="col-sm-8">
        ...
        <div :class="errors.marital_status ? 'form-group has-error' : 'form-group'">
            <label for="marital_status" class="col-sm-4 control-label">Marital status<span
                    class="spanHighlight">*</span></label>
            <div class="col-sm-8">
                <select class="form-control w-min" id="marital_status" name="marital_status"
                    ...
                    <option value="legally_seperated">Legally separated</option>
        ...
        <template v-if="model.marital_status == 'married'">
            ...
            <div :class="errors.spouse_experience ? 'form-group has-error' : 'form-group'">
                <label for="child-6" class="col-sm-4 control-label">Your spouse's experience?<span
                        class="spanHighlight">*</span></label>
                <div class="col-sm-8">
                    <label class="radio">
                        <input type="radio" v-model="model.spouse_experience" value="1">Work Experience as a Business
                        person</label>
                    <label class="radio">
                        <input type="radio" v-model="model.spouse_experience" value="2">Work Experience as a Skilled
                        Worker</label>
                    <label class="radio">
                        <input type="radio" v-model="model.spouse_experience" value="3">Not employed currently</label>
                    <label class="radio">
                        <input type="radio" v-model="model.spouse_experience" value="4">Never employed</label>
                    <label class="radio">
                        <input type="radio" v-model="model.spouse_experience" value="5">NA</label>
        ...
        <template
            ...
            <div :class="errors.no_of_children ? 'form-group has-error' : 'form-group'">
                <label for="marital_status" class="col-sm-4 control-label">How many children do you have?<span
                        class="spanHighlight">*</span></label>
                <div class="col-sm-8">
            ...
            <div :class="errors.has_children_lt_22 ? 'form-group has-error' : 'form-group'">
                <label for="child-6" class="col-sm-4 control-label">Do you have children less than 22 years of age? You
                    can include them in your PR application*<span class="spanHighlight">*</span></label>
                <div class="col-sm-8">
                    <label class="radio-inline">
            ...
            <div :class="errors.children_enrolled ? 'form-group has-error' : 'form-group'">
                <label for="child-6" class="col-sm-4 control-label">Do you have children enrolled in accredited
                    Canadian education institution/s and are actively pursuing academic, professional or vocational
                    training on a full-time basis?<span class="spanHighlight">*</span></label>
                <div class="col-sm-8">
                    <label class="radio-inline">
            ...
            <div :class="errors.children_canadian ? 'form-group has-error' : 'form-group'">
                <label for="child-6" class="col-sm-4 control-label">Do you have any of your children who are Canadian
                    citizens or permanent residents of Canada?<span class="spanHighlight">*</span></label>
                <div class="col-sm-8">
                    <label class="radio-inline">
            ...
            <div :class="errors.children_mental ? 'form-group has-error' : 'form-group'">
                <label for="child-6" class="col-sm-4 control-label">Do you, your spouse or your children have a
        ...
        <div :class="errors.ordered_to_leave ? 'form-group has-error' : 'form-group'">
            <label for="child-6" class="col-sm-4 control-label">Have you been ordered to leave Canada or any other
                country?<span class="spanHighlight">*</span></label>
            <div class="col-sm-8">
                <label class="radio-inline">
        ...
        <div :class="errors.arrested ? 'form-group has-error' : 'form-group'">
            <label for="child-6" class="col-sm-4 control-label">Have you ever committed, been arrested for, or been
                charged with any offense in any country, including driving under the influence of alcohol or drugs?<span
                    class="spanHighlight">*</span></label>
            <div class="col-sm-8">
                <label class="radio-inline">
        ...
        <div :class="errors.been_military ? 'form-group has-error' : 'form-group'">
            <label for="child-6" class="col-sm-4 control-label">Have you ever been in the military (including mandatory
        ...
        <div :class="errors.employed_security ? 'form-group has-error' : 'form-group'">
            <label for="child-6" class="col-sm-4 control-label">Have you ever been employed by a government in a
                security-related capacity?<span class="spanHighlight">*</span></label>
            <div class="col-sm-8">
                <label class="radio-inline">
        ...
        <div :class="errors.visited ? 'form-group has-error' : 'form-group'">
            <label for="child-6" class="col-sm-4 control-label">Have you visited other countries within the last 10
                years?<span class="spanHighlight">*</span></label>
            <div class="col-sm-8">
                <label class="radio-inline">
        ...
        <template v-if="model.visited == 'yes'">
            <div :class="errors.visited_countries ? 'form-group has-error' : 'form-group'">
                <label for="visited_countries" class="col-sm-4 control-label">If Yes, please list the countries<span
                        class="spanHighlight">*</span></label>
                <div class="col-sm-8">
                    <select multiple class="form-control w-min" id="visited_countries" name="visited_countries"
        ...
        <div :class="errors.has_blood_relative ? 'form-group has-error' : 'form-group'">
            <label for="child-6" class="col-sm-4 control-label">Do you or your spouse have blood relatives in
                Canada?<span class="spanHighlight">*</span></label>
            <div class="col-sm-8">
                <label class="radio-inline">
        ...
        <template v-if="model.has_blood_relative == 'yes'">
            <div :class="errors.relative_province ? 'form-group has-error' : 'form-group'">
                <label for="aoi" class="col-sm-4 control-label">If yes, please state the province they reside in (you
                    can select more than one)<span class="spanHighlight">*</span></label>
                <div class="col-sm-8">
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" value="british_columbia" v-model="model.relative_province" />British
                            Columbia</label>
                    </div>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" value="alberta" v-model="model.relative_province" />Alberta</label>
                    </div>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" value="saskatchewan"
                                v-model="model.relative_province" />Saskatchewan</label>
                    </div>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" value="manitoba" v-model="model.relative_province" />Manitoba</label>
                    </div>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" value="ontario" v-model="model.relative_province" />Ontario</label>
                    </div>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" value="quebec" v-model="model.relative_province" />Quebec</label>
                    </div>
                    <div class="checkbox">
                        <label>
                    ...
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" value="prince_edward_island"
                                v-model="model.relative_province" />Prince Edward Island</label>
                    </div>
                    <div class="checkbox">
                        <label>
        ...
        <div :class="errors.visited_canada ? 'form-group has-error' : 'form-group'">
            <label for="child-6" class="col-sm-4 control-label">Have you ever visited Canada ?<span
                    class="spanHighlight">*</span></label>
            <div class="col-sm-8">
                <label class="radio-inline">
        ...
        <template v-if="model.visited_canada == 'yes'">
            <div :class="errors.visited_in_2 ? 'form-group has-error' : 'form-group'">
                <label for="child-6" class="col-sm-4 control-label">Did you visit Canada in the last 2 years?*<span
                        class="spanHighlight">*</span></label>
                <div class="col-sm-8">
                    <label class="radio-inline">
            ...
            <template v-if="model.visited_in_2 == 'yes'">
                <div :class="errors.visited_province ? 'form-group has-error' : 'form-group'">
                    <label for="aoi" class="col-sm-4 control-label">If yes, please state the provinces visited (you can
                        select more than one)<span class="spanHighlight">*</span></label>
                    <div class="col-sm-8">
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" value="british_columbia"
                                    v-model="model.visited_province" />British
                                Columbia</label>
                        </div>
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" value="alberta"
                                    v-model="model.visited_province" />Alberta</label>
                        </div>
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" value="saskatchewan"
                                    v-model="model.visited_province" />Saskatchewan</label>
                        </div>
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" value="manitoba"
                                    v-model="model.visited_province" />Manitoba</label>
                        </div>
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" value="ontario"
                                    v-model="model.visited_province" />Ontario</label>
                        </div>
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" value="quebec" v-model="model.visited_province" />Quebec</label>
                        </div>
                        <div class="checkbox">
                            <label>
                        ...
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" value="prince_edward_island"
                                    v-model="model.visited_province" />Prince Edward Island</label>
                        </div>
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" value="newfoundland_and_labrador"
        ...
        <div :class="errors.refused ? 'form-group has-error' : 'form-group'">
            <label for="child-6" class="col-sm-4 control-label">Has your visa to Canada ever been refused?<span
                    class="spanHighlight">*</span></label>
            <div class="col-sm-8">
                <label class="radio-inline">
        ...
        <template v-if="model.refused == 'yes'">
            <div :class="errors.refused_detail ? 'form-group has-error' : 'form-group'">
                <label for="fullname" class="col-sm-4 control-label">If Yes, please provide when and related
                    detail<span class="spanHighlight">*</span>
                    (As per
                    your passport)</label>
                <div class="col-sm-8">
                    <input name="refused_detail" class="form-control w-min" v-model="model.refused_detail">
        ...
        <div :class="errors.assets ? 'form-group has-error' : 'form-group'">
            <label for="child-6" class="col-sm-4 control-label">Between you and your spouse, please calculate the total
                value of your assets, including movable, immovable property/properties, cash in the bank, mutual funds,
                fixed deposits, etc. Please calculate in Canadian dollars. If you wish to convert from any currency to
                Canadian dollars, please visit www.xe.com. Please remember to include and assess only those assets that
                are in your and your spouse's name.<span class="spanHighlight">*</span></label>
            <div class="col-sm-8">
                <label class="radio">
                    <input type="radio" v-model="model.assets" value="1">$100,000 to $199,000</label>
                <label class="radio">
                    <input type="radio" v-model="model.assets" value="2">$200,000 to $299,000</label>
                <label class="radio">
                    <input type="radio" v-model="model.assets" value="3">$300,000 to $399,000</label>
                <label class="radio">
                    <input type="radio" v-model="model.assets" value="4">$400,000 to $499,000</label>
                <label class="radio">
                    <input type="radio" v-model="model.assets" value="5">$500,000 to $599,000</label>
                <label class="radio">
                    <input type="radio" v-model="model.assets" value="5">$600,000 to $799,000</label>
                <label class="radio">
                    <input type="radio" v-model="model.assets" value="5">$800,000 to $999,000,</label>
                <label class="radio">
                    <input type="radio" v-model="model.assets" value="5">$1 million to $2 million</label>
                <label class="radio">
                    <input type="radio" v-model="model.assets" value="5">$2 million and up</label>
        ...
        <div :class="errors.language_test ? 'form-group has-error' : 'form-group'">
            <label for="child-6" class="col-sm-4 control-label">Have you taken English proficiency test (IELTS or
                CELPIP) ?<span class="spanHighlight">*</span></label>
            <div class="col-sm-8">
                <label class="radio-inline">
        ...
        <template v-if="model.language_test == 'yes'">
            <label for="child-6" class="col-sm-4 control-label">If yes, what is your score in</label>
        ...
        <template v-if="model.language_test == 'no'">
            <div :class="errors.language_proficiency ? 'form-group has-error' : 'form-group'">
                <label for="child-6" class="col-sm-4 control-label">If you have not taken an English proficiency test,
                    how do you rate your English language proficiency?</label>
                <div class="col-sm-8">
                    <label class="radio">
        ...
        <div :class="errors.interested_programs ? 'form-group has-error' : 'form-group'">
            <label for="interested_programs" class="col-sm-4 control-label">I am interested in the following Canada's
                business
            ...
            <div class="col-sm-8">
                ...
                <div class="checkbox">
                    <label>
                        <input type="checkbox" value="2" v-model="model.interested_programs" />I operate my own business
                ...
                <div class="checkbox">
                    <label>
                        <input type="checkbox" value="4" v-model="model.interested_programs" />Canada's personal Nominee
                        program for business person & Senior Managers</label>
                </div>
                <div class="checkbox">
                    <label>
                        <input type="checkbox" value="5" v-model="model.interested_programs" />LMIA / work permit as a
                        business owner / operator in Canada</label>
                </div>
                <div class="checkbox">
                    <label>
                        <input type="checkbox" value="6" v-model="model.interested_programs" />I am open to Discuss all
        ...
        <div :class="errors.prefered_location ? 'form-group has-error' : 'form-group'">
            <label for="prefered_location" class="col-sm-4 control-label">What is your current country of
                residence?<span class="spanHighlight">*</span></label>
            <div class="col-sm-8">
                <select class="form-control w-min" id="prefered_location" name="prefered_location"
