                ...
                <div class="moto-widget moto-widget-contact_form moto-preset-2 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto"
                    ...
                    <div>
                        <form class="moto-widget-contact_form-form ng-pristine ng-invalid ng-invalid-required"
                            action="{{ route('callback.form.submit') }}" accept-charset='UTF-8' method="POST">
                            @csrf
                            <div class="moto-widget-contact_form-group">
                                <label for="form1-name" class="moto-widget-contact_form-label">Name</label>
                                <input type="text" class="moto-widget-contact_form-field moto-widget-contact_form-input"
                                    placeholder="Name *" required="true" name="name" @if ($errors->any()) autofocus @endif
                                    value="{{ old('name') }}">
                                @error('name')
                            ...
                            <div class="moto-widget-contact_form-buttons">
                                <div class="moto-widget moto-widget-button moto-preset-2 moto-preset-provider-default moto-align-left"
                                    ...
                                    <button type="submit" class="g-recaptcha moto-widget-button-link moto-size-medium">
